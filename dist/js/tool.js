...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__PaginationLinks_vue__ = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_dayjs__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_dayjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_dayjs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_dayjs_plugin_duration__ = __webpack_require__(25);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_dayjs_plugin_utc__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__FilterMenu__ = __webpack_require__(27);
          ...
          _c("div", [
            _c(
              "button",
              {
                ...
                attrs: { disabled: !_vm.hasMore, dusk: "next", rel: "next" },
                on: {
                  click: function($event) {
                    $event.preventDefault()
                    return _vm.nextPage()
                    ...
                    _c(
                      ...
                      _vm._l(_vm.data, function(row) {
                        return _c("tr", [
                          ...
                          _vm._v(" "),
                          _c("td", [_vm._v(_vm._s(row.path))]),
                          _vm._v(" "),
                          _c("td", [_vm._v(_vm._s(row.visits))]),
                          _vm._v(" "),
                          _c("td", [_vm._v(_vm._s(row.unique_visits))]),
                          _vm._v(" "),
                          _c("td", [
                            _vm._v(
                              _vm._s(_vm.getFormattedTime(row.avg_page_time))
                            )
                          ]),
                          _vm._v(" "),
                          _c("td", [_vm._v(_vm._s(row.entrances))]),
                          _vm._v(" "),
                          _c("td", [
                            _vm._v(
                              _vm._s(_vm.getFormattedPercent(row.bounce_rate))
                            )
                          ]),
                          _vm._v(" "),
                          _c("td", [
                            _vm._v(
                              _vm._s(_vm.getFormattedPercent(row.exit_rate))
                            )
                          ]),
                          _vm._v(" "),
                          _c("td", [
                            _vm._v(
                              _vm._s(_vm.getFormattedCurrency(row.page_value))
                            )
                          ])
                        ])
                      }),
