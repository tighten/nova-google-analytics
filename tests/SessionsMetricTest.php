...
class SessionsMetricTest extends TestCase
{
    ...
    {
        $response = (new SessionsMetric)->calculate($this->requestWithQueryParams(['range' => 'Y']));
        $this->assertFalse(empty($response));
    }
    ...
    {
        $response = (new SessionsMetric)->calculate($this->requestWithQueryParams(['range' => 'LW']));
        $this->assertFalse(empty($response));
    }
    ...
    {
        $response = (new SessionsMetric)->calculate($this->requestWithQueryParams(['range' => 'LM']));
        $this->assertFalse(empty($response));
    }
    ...
    {
        $response = (new SessionsMetric)->calculate($this->requestWithQueryParams(['range' => '7']));
        $this->assertFalse(empty($response));
    }
    ...
    {
        $response = (new SessionsMetric)->calculate($this->requestWithQueryParams(['range' => '30']));
        $this->assertFalse(empty($response));
    }
